                                    ...
                                    const PoseFreeFn &pose_free) const
{
    ...
    {
        // The search already reached the configured goal tolerance. Keeping
        // the exact topo point as the final guide makes downstream indexing
        // deterministic; TrajectoryGenerator remains responsible for the
        // final curve/fallback acceptance checks.
