...
class MyWindow(QWidget):
    ...
    def build_autonav_parameters_page(self):
        page = QWidget()
        layout = QVBoxLayout(page)
        # This page has several dense numeric controls.  Keep its spacing
        # tighter than the task pages so the whole form remains visible at
        # the supported 820x720 minimum window size.
