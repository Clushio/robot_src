...
def generate_launch_description():
    ...
    update_rate_arg = DeclareLaunchArgument(
        'update_rate', default_value='50', description='Driver update rate')
    robot_model_arg = DeclareLaunchArgument(
        'robot_model', default_value='ranger_mini_v2',
    ...
    stop_wait_timeout_arg = DeclareLaunchArgument(
        'stop_wait_timeout', default_value='2.0')
    mode_switch_timeout_arg = DeclareLaunchArgument(
        'mode_switch_timeout', default_value='2.0')
    centering_timeout_arg = DeclareLaunchArgument(
        'centering_timeout', default_value='3.0')
    stop_stable_frames_arg = DeclareLaunchArgument(
        'stop_stable_frames', default_value='3')
    center_stable_frames_arg = DeclareLaunchArgument(
        'center_stable_frames', default_value='3')
    ranger_base_node = Node(
        ...
        parameters=[{
            ...
            'stop_velocity_threshold': LaunchConfiguration(
                'stop_velocity_threshold'),
            'stop_wheel_speed_threshold': LaunchConfiguration(
                'stop_wheel_speed_threshold'),
            'steering_center_tolerance': LaunchConfiguration(
                'steering_center_tolerance'),
            'stop_wait_timeout': LaunchConfiguration('stop_wait_timeout'),
            'mode_switch_timeout': LaunchConfiguration('mode_switch_timeout'),
            'centering_timeout': LaunchConfiguration('centering_timeout'),
            'stop_stable_frames': LaunchConfiguration('stop_stable_frames'),
            'center_stable_frames': LaunchConfiguration(
                'center_stable_frames'),
        }])
